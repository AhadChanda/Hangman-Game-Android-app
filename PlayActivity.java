...
public class PlayActivity extends Activity {
	...
	protected void onSaveInstanceState(Bundle savedInstanceState) {
		...
		savedInstanceState.putSerializable(String.valueOf(CUR_LEVEL),curlevel);
		savedInstanceState.putSerializable(String.valueOf(CUR_MAN),curMan);
		//savedInstanceState.putInt(String.valueOf(BTN),B);
	}

	@Override
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		super.onRestoreInstanceState(savedInstanceState);
		curlevel =(int) savedInstanceState.getInt(String.valueOf(CUR_LEVEL));
		curMan =(int) savedInstanceState.getInt(String.valueOf(CUR_MAN));
		//b = (Button) savedInstanceState.getInt(BTN);
